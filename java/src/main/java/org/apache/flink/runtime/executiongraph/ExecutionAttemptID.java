...
public class ExecutionAttemptID implements java.io.Serializable {
    ...
    private int subTaskNum = 0;     // for this subTask, indicate the number of subtasks sharing the same slot
    private int slotFalconSize = 0; // for this subTask, falcon cache size of it's slot

    public void setSubTaskNum(int numSubTasks) { subTaskNum = numSubTasks; }

    public void setSlotFalconSize(int falconSize) { slotFalconSize = falconSize; }
