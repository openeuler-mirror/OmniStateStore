 ...
 */
public class TableEntryIterator<K, V> extends AbstractNativeHandleReference
    implements CloseableIterator<Map.Entry<K, V>> {
    private static final Logger LOG = LoggerFactory.getLogger(TableEntryIterator.class);
    ...
    public TableEntryIterator(long nativeTableAddress, TableSerializer<K, V> tableSerializer) {
    ...
    public Map.Entry<K, V> next() {
        ...
        try {
            ...
            LOG.error("deserialize map entry failed.", e);
