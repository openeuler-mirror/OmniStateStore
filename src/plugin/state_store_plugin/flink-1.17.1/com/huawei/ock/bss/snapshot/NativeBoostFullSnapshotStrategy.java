...
public class NativeBoostFullSnapshotStrategy<K> extends BoostSnapshotStrategyBase<K> {
    ...
    private final com.huawei.ock.bss.snapshot.BoostStateUploader stateUploader;

    private String jobID;

    public NativeBoostFullSnapshotStrategy(
        @Nonnull String jobID,
        @Nonnull BoostStateDB db, @Nonnull ResourceGuard resourceGuard,
    ...
    private final class BoostNativeFullSnapshotOperation extends BoostDBSnapshotOperation {
        ...
        public SnapshotResult<KeyedStateHandle> get(CloseableRegistry closeableRegistry) throws Exception {
            ...
            try {
                ...
                final IncrementalRemoteKeyedStateHandle jmIncrementalKeyedStateHandle
                    ...
                    Collections.emptyMap(), privateFiles, metaStateHandle.getJobManagerOwnedSnapshot(),
                    checkpointedSize);
        ...
        private long uploadSnapshotFiles(@Nonnull Map<StateHandleID, StreamStateHandle> privateFiles,
            ...
            privateFiles.putAll(
                    stateUploader.uploadFilesToCheckpointFs(
                            ...
                            snapshotCloseableRegistry, tmpResourcesRegistry));
            uploadedSize += privateFiles.values().stream()
